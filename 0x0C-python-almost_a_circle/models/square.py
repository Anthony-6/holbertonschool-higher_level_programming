...
use the logic of the __init__ of the Rectangle class. The width and height must be assigned
...
All width, height, x and y validation must inherit from Rectangle - same behavior in case
of wrong data
The overloading __str__ method should return [Square] (<id>) <x>/<y> - <size> - in our case,
width or height
'''
